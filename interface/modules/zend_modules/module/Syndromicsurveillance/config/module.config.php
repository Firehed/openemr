...
return [
    ...
    'service_manager' => [
        'factories' => [
            SyndromicsurveillanceTable::class => fn(ContainerInterface $container, $requestedName): \Syndromicsurveillance\Model\SyndromicsurveillanceTable => new SyndromicsurveillanceTable()
        ],
    ]
];
